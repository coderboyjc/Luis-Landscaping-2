...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-green-700 text-white hover:bg-green-800 focus:ring-green-600 shadow-md",
    ...
    white: "bg-white text-green-900 hover:bg-stone-100 focus:ring-white shadow-md"
  };
